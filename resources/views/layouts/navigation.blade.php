            ...
            <div class="flex">
                ...
                <div class="shrink-0 flex items-center">
                    <a href="{{ route('home') }}" class="flex items-center">
                        <x-logo class="text-blue-600 text-2xl" />
                        <span class="ml-2 text-xl font-bold text-gray-800 hidden sm:inline">PlanMaison3D</span>
                    </a>
                </div>
            ...
            <div class="hidden sm:flex sm:items-center sm:ms-6">
                ...
                @else
                    <div class="hidden sm:flex sm:items-center sm:ml-6">
                        <a href="{{ route('user.login') }}" class="text-sm text-gray-700 dark:text-gray-500 underline">Connexion</a>

                        @if (Route::has('user.register'))
                            <a href="{{ route('user.register') }}" class="ml-4 text-sm text-gray-700 dark:text-gray-500 underline">Inscription</a>
                        @endif
                    </div>
                @endauth
            </div>
